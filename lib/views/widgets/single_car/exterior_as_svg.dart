...
class CarExteriorCondition extends StatelessWidget {
  final Map<String, String> defects;

  const CarExteriorCondition({@required this.defects});
  ...
  Widget build(BuildContext context) {
    ...
    final colorList = ["grey", "orange", "red", "yellow", "blue", "white"];
    ...
    return Column(
      ...
      children: [
          ...
          child: SvgPicture.string('''
            <svg
                    ...
                    <path
                        ...
                        stroke="black"
                        fill="${colorList[typeList.indexOf(defects['frontBumper']) % 6]}"
                    >
                    ...
                    <path
                        ...
                        stroke="black"
                        fill="${colorList[typeList.indexOf(defects['hood']) % 6]}"
                    >
                        <title>Hood</title>
                    </path>
                    <path
                    ...
                    <path
                        ...
                        stroke="black"
                        fill="${colorList[typeList.indexOf(defects['top']) % 6]}"
                    >
                        <title>Top</title>
                    </path>
                    <path
                    ...
                    <path
                        ...
                        stroke="black"
                        fill="${colorList[typeList.indexOf(defects['trunkLid']) % 6]}"
                    >
                    ...
                    <path
                        ...
                        stroke="black"
                        fill="${colorList[typeList.indexOf(defects['backBumper']) % 6]}"
                    >
                    ...
                    <path
                        ...
                        stroke="black"
                        fill="${colorList[typeList.indexOf(defects['rightFrontPanel']) % 6]}"
                    >
                    ...
                    <path
                        ...
                        stroke="black"
                        fill="${colorList[typeList.indexOf(defects['rightFrontBumper']) % 6]}"
                    >
                        <title>Right Front Panel</title>
                    </path>
                    ...
                    <path
                        ...
                        stroke="black"
                        fill="${colorList[typeList.indexOf(defects['leftFrontPanel']) % 6]}"
                    >
                    ...
                    <path
                        ...
                        stroke="black"
                        fill="${colorList[typeList.indexOf(defects['leftFrontBumper']) % 6]}"
                    >
                    ...
                    <path
                        ...
                        stroke="black"
                        fill="${colorList[typeList.indexOf(defects['rightFrontDoor']) % 6]}"
                    >
                    ...
                    <path
                        ...
                        stroke="black"
                        fill="${colorList[typeList.indexOf(defects['rightBackDoor']) % 6]}"
                    >
                    ...
                    <path
                        ...
                        stroke="black"
                        fill="${colorList[typeList.indexOf(defects['rightBackPanel']) % 6]}"
                    >
                    ...
                    <path
                        ...
                        stroke="black"
                        fill="${colorList[typeList.indexOf(defects['rightBackBumper']) % 6]}"
                    >
                    ...
                    <path
                        ...
                        stroke="black"
                        fill="${colorList[typeList.indexOf(defects['leftFrontDoor']) % 6]}"
                    >
                    ...
                    <path
                        ...
                        stroke="black"
                        fill="${colorList[typeList.indexOf(defects['leftBackDoor']) % 6]}"
                    >
                    ...
                    <path
                        ...
                        stroke="black"
                        fill="${colorList[typeList.indexOf(defects['leftBackPanel']) % 6]}"
                    >
                    ...
                    <path
                        ...
                        stroke="black"
                        fill="${colorList[typeList.indexOf(defects['leftBackBumper']) % 6]}"
                    >
        ...
        colorAndTitle(Colors.white, "Original"),
        colorAndTitle(Colors.orange, "Damaged"),
        colorAndTitle(Colors.red, "Repainted"),
        colorAndTitle(Colors.yellow, "Portion Repainted"),
        colorAndTitle(Colors.blue, "Foiled"),
        colorAndTitle(Colors.grey, "Not Available"),
        SizedBox(
          height: 20,
        ),
      ],
  ...
  Widget colorAndTitle(Color color, String title) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.start,
      children: [
        Expanded(flex: 1, child: SizedBox()),
        Container(
          decoration: BoxDecoration(color: color, border: Border.all(width: 1, color: Colors.black)),
          height: 15,
          width: 15,
        ),
        SizedBox(
