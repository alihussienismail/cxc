...
class BidCardSold extends StatefulWidget {
  Car car;
  ...
  @override
  State<BidCardSold> createState() => _BidCardSoldState();
}

class _BidCardSoldState extends State<BidCardSold> {
